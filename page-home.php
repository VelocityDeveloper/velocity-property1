...
<div class="wrapper" id="page-wrapper">
    ...
    <img class="home-bottom-post-thumb rounded-0" src="<?php the_post_thumbnail_url('large'); ?>" >
    </a>
    <div class="card-body px-0">
        <div class="text-dark"><?php echo get_the_date(); ?></div>
        <h5 class="card-title mb-2" style="line-height: 1.4;"><a class="text-dark" href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h5>
